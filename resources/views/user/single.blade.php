              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    @if($user->img==NULL)
                    <img src="/coursel/nimg.png" alt="Admin" class="rounded-circle" width="150">
                    @else
                    <img src="/images/{{$user->img}}" alt="Admin" class="rounded-circle" width="200">
                    @endif
                    <div class="mt-3">
                      <h4> {{ $user->name}}</h4>
                      ...
                      <a href="/user/edit/{{ $user->name }}">  <button class="btn btn-primary">Edit Profile </button></a>
